...
export default function DashboardPage() {
  ...
  const NavLinks = () => (
    <>
      ...
      <Link href="/my-applications" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-white/50 hover:text-white hover:bg-white/5 transition-all font-body text-sm">
        <Shield className="w-4 h-4" /> My Applications
      </Link>
      <Link href="/lender" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-white/50 hover:text-white hover:bg-white/5 transition-all font-body text-sm">
        <TrendingUp className="w-4 h-4 text-blue-400" /> Lender Portal
      </Link>
    </>
  );
